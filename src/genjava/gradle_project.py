...
def create(msg_pkg_name, output_dir):
    ...
    '''
    print("\nCreating genjava project ")
    print("  Name      : %s" % msg_pkg_name)

    genjava_gradle_dir = os.path.join(output_dir, 'genjava_gradle')
    ...
    #create_rosjava_project.create_rosjava_project_common(project_name, author, output_dir, 'rosjava_msg_project')
